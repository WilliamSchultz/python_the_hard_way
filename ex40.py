...
#class: mini module
#OOP: means there is a construct called a class
...
happy_bday = Song(["Happy birthday to you",   #list 0  #Instantiation
...
Imagine = Song(["Imagine all the people",
                "living for today",
                "oooh ooooh"])

Boss = "Everybody's got a hungry heart"
